...
namespace kse.mes.processapplication
{
	...
	[ACPropertyEntity(100, "Bit08", "en{'Alarm dustcover seal'}de{'Alarm dustcover seal'}")]
	[ACPropertyEntity(101, "Bit09", "en{'Alarm discharge valve'}de{'Alarm discharge valve'}")]
	[ACPropertyEntity(102, "Bit10", "en{'Alarm frequency controller'}de{'Alarm frequency controller'}")]
	[ACPropertyEntity(103, "Bit11", "en{'Alarm dedusting mouth'}de{'Alarm dedusting mouth'}")]
	...
	// @aagincic: AutoGenerated file form AlarmDustExhaust.csv definition
    public class AlarmDustExhaust :  BitAccessForInt16
	{
		#region c'tors
        public AlarmDustExhaust()
        {
        }

        public AlarmDustExhaust(IACType acValueType)
            : base(acValueType)
        {
        }
        #endregion
		...
		public bool Bit08_AlarmDustcoverSeal
		{
			get { return Bit08; }
			set { Bit08 = value; }
		}
		 
		public bool Bit09_AlarmDischargeValve
		{
			get { return Bit09; }
			set { Bit09 = value; }
		}
		 
		public bool Bit10_AlarmFrequencyController
		{
			get { return Bit10; }
			set { Bit10 = value; }
		}
		 
		public bool Bit11_AlarmDedustingMouth
		{
			get { return Bit11; }
			set { Bit11 = value; }
		}
